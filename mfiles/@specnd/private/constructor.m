function D = constructor(varargin)
% creates specnd object
%
% D = CONSTRUCTOR(axis, signal, {error}, {monitor}, 'Option1', Value1, ...)
%
% Input:
%
% axis      Matrix or cell, to generate axis automatically give {}.
% signal    Matrix
...
if nVari > 1
    ...
    if iscell(varargin{1})
        if ~isempty(varargin{1})
            ...
            if numel(axDim) == 1 && numel(sigDim)<=2 && sigDim(2) == 1
                sigDim = sigDim(1); 
            end
